...
<template>
  <form @submit.prevent="handleLogin" class="space-y-4">
    ...
    <div
      v-if="msg && !error"
      class="alert alert-success text-sm py-3 shadow-md"
    >
    ...
    <div class="form-control">
      <div class="label px-1 py-1 flex justify-between">
        ...
        <RouterLink
          ...
          class="label-text-alt link link-primary opacity-70 hover:opacity-100 font-bold"
          >Forgot password?</RouterLink
        >
      </div>
      <label
        class="input input-bordered flex items-center gap-2 focus-within:input-primary transition-all"
